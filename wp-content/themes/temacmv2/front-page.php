...
<main id="primary" class="site-main">
    ...
    <!-- DIFERENCIAIS -->
    <section id="diferenciais" class="py-20 px-6 border-y border-white/5 bg-slate-900/30">
        <div class="container mx-auto">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
                <div>
                    <div class="text-4xl md:text-5xl font-display font-bold text-white mb-2">+15</div>
                    <p class="text-slate-400 font-mono text-xs uppercase tracking-widest">Anos de Mercado</p>
                </div>
                <div>
                    <div class="text-4xl md:text-5xl font-display font-bold text-white mb-2">+500</div>
                    <p class="text-slate-400 font-mono text-xs uppercase tracking-widest">Clientes</p>
                </div>
                <div>
                    <div class="text-4xl md:text-5xl font-display font-bold text-blue-500 mb-2">ISO 9001</div>
                    <p class="text-slate-400 font-mono text-xs uppercase tracking-widest">Qualidade Padrão</p>
                </div>
                <div>
                    <div class="text-4xl md:text-5xl font-display font-bold text-white mb-2">24/7</div>
                    <p class="text-slate-400 font-mono text-xs uppercase tracking-widest">Suporte Técnico</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- SOBRE NÓS -->
    <section id="sobre" class="py-24 px-6 overflow-hidden">
        <div class="container mx-auto max-w-6xl">
            <div class="grid md:grid-cols-2 gap-16 items-center">
                <div class="relative">
                    <div class="w-full aspect-square bg-blue-500/5 border border-white/5 rounded-2xl flex items-center justify-center p-12">
                         <div class="text-slate-700 text-9xl font-display font-bold select-none opacity-20 italic">C&M</div>
                    </div>
                </div>
                <div>
                    <span class="text-blue-500 font-mono text-sm tracking-widest font-bold uppercase mb-4 block">Institucional</span>
                    <h2 class="text-4xl md:text-5xl font-display font-bold mb-8">Parceria Estratégica <br/> em Engenharia.</h2>
                    <div class="space-y-6 text-slate-400 leading-relaxed text-lg font-sans">
                        <p>
                            A C&M Global Services nasceu da necessidade de unir o rigor técnico da engenharia tradicional com a agilidade e inovação da tecnologia digital.
                        </p>
                        <p>
                            Nossa expertise abrange desde infraestrutura elétrica de alta complexidade até sistemas inteligentes de Segurança e Saúde no Trabalho (SST), garantindo que sua operação seja conformidade e performática ao mesmo tempo.
                        </p>
                    </div>
                    <div class="mt-10">
                         <a href="#contato" class="text-white font-bold border-b-2 border-blue-500 pb-1 hover:border-white transition-all">Saiba mais sobre nossa história &rarr;</a>
                    </div>
                </div>
            </div>
        </div>
